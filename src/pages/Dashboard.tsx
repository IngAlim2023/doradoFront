...
const Dashboard: React.FC = () => {
  ...
  //Para poder listar los pasajeros de un solo vuelo:
  const [codFPa, setCodFPa] = useState<string>("");
  ...
  return (
    <>
      ...
      />
      <PassengerListModal
        isOpen={openPassengersModal}
        onClose={() => setOpenPassengersModal(false)}
        codFPa={codFPa}
        setCodFPa={setCodFPa}
      />
      ...
      <div className="min-h-screen bg-gray-100 p-6">
        <header className="flex items-center justify-between mb-6">
          ...
          <button
            className="bg-white px-4 py-2 border rounded-lg hover:bg-gray-100 transition text-sm font-medium flex items-center gap-2"
            onClick={() => {
              close();
            }}
          >
